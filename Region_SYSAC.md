...
| define | value |
| --- | --- |
| SYSAC_DBG_PRIORITY_PRIORITY_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_L2_ALGORITHM_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_L2_DELAY_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_L2_LIMIT_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_L2_THRESHOLD_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_LITE_ALGORITHM_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_LITE_CHANNEL_INIBIT_RESET0x0 |  |
| SYSAC_DMA_ARBITER_CONTROL_LITE_DELAY_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_LITE_LIMIT_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_LITE_THRESHOLD_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_PER_ALGORITHM_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_PER_CHANNEL_INIBIT_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_PER_DELAY_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_PER_LIMIT_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_PER_THRESHOLD_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_UC_ALGORITHM_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_UC_CHANNEL_INIBIT_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_UC_DELAY_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_UC_LIMIT_RESET | 0x0 |
| SYSAC_DMA_ARBITER_CONTROL_UC_THRESHOLD_RESET | 0x0 |
| SYSAC_DMA_DREQ_CONTROL_DMA_DBG_PAUSE_OR_RESET | 0x0 |
| SYSAC_DMA_DREQ_CONTROL_SMI_DISABLE_RESET | 0x0 |
| SYSAC_DUMMY_STATUS_IDLE_RESET | 0x0 |
| SYSAC_H264_PRIORITY_PRIORITY_RESET | 0x0 |
| SYSAC_HOST_PRIORITY_PRIORITY_RESET | 0x0 |
| SYSAC_HVSM_PRIORITY_N_PRIORITY_RESET | 0x0 |
| SYSAC_HVSM_PRIORITY_P_PRIORITY_RESET | 0x0 |
| SYSAC_ISP_PRIORITY_PRIORITY_RESET | 0x0 |
| SYSAC_JPEG_PRIORITY_N_PRIORITY_RESET | 0x0 |
| SYSAC_JPEG_PRIORITY_P_PRIORITY_RESET | 0x0 |
| SYSAC_L2_ARBITER_CONTROL_ALGORITHM_RESET | 0x0 |
| SYSAC_L2_ARBITER_CONTROL_CHANNEL_INIBIT_RESET | 0x0 |
| SYSAC_L2_ARBITER_CONTROL_DELAY_RESET | 0x0 |
| SYSAC_L2_ARBITER_CONTROL_LIMIT_RESET | 0x0 |
| SYSAC_L2_ARBITER_CONTROL_THRESHOLD_RESET | 0x0 |
| SYSAC_PERI_ARBITER_CONTROL_ALGORITHM_RESET | 0x0 |
| SYSAC_PERI_ARBITER_CONTROL_CHANNEL_INIBIT_RESET | 0x0 |
| SYSAC_PERI_ARBITER_CONTROL_DELAY_RESET | 0x0 |
| SYSAC_PERI_ARBITER_CONTROL_LIMIT_RESET | 0x0 |
| SYSAC_PERI_ARBITER_CONTROL_THRESHOLD_RESET | 0x0 |
| SYSAC_SRC_ARBITER_CONTROL_ALGORITHM_RESET | 0x0 |
| SYSAC_SRC_ARBITER_CONTROL_CHANNEL_INIBIT_RESET | 0x0 |
| SYSAC_SRC_ARBITER_CONTROL_DELAY_RESET | 0x0 |
| SYSAC_SRC_ARBITER_CONTROL_LIMIT_RESET | 0x0 |
| SYSAC_SRC_ARBITER_CONTROL_THRESHOLD_RESET | 0x0 |
| SYSAC_TRANS_PRIORITY_N_PRIORITY_RESET | 0x0 |
| SYSAC_TRANS_PRIORITY_P_PRIORITY_RESET | 0x0 |
| SYSAC_UC_ARBITER_CONTROL_ALGORITHM_RESET | 0x0 |
| SYSAC_UC_ARBITER_CONTROL_CHANNEL_INIBIT_RESET | 0x0 |
| SYSAC_UC_ARBITER_CONTROL_DELAY_RESET | 0x0 |
| SYSAC_UC_ARBITER_CONTROL_LIMIT_RESET | 0x0 |
| SYSAC_UC_ARBITER_CONTROL_THRESHOLD_RESET | 0x0 |
| SYSAC_USB_PRIORITY_PRIORITY_RESET | 0x0 |
| SYSAC_V3D_LIMITER_ENABLE_RESET | 0x0 |
| SYSAC_V3D_LIMITER_HOLDOFF_RESET | 0x0 |
| SYSAC_V3D_LIMITER_INCREMENT_RESET | 0x0 |
| SYSAC_V3D_LIMITER_MAX_PRIORITY_RESET | 0x0 |
| SYSAC_V3D_LIMITER_SPARE_RESET | 0x0 |
| SYSAC_V3D_PRIORITY_PRIORITY_RESET | 0x0 |

...
| define | value |
| --- | --- |
| HDMI_ASYNC_RM_BASE | HDMI_ASYNC_RM_BASE |
| HDMI_ASYNC_RM_CONTROL | HDMI_ASYNC_RM_CONTROL |
| HDMI_ASYNC_RM_FORMAT | HDMI_ASYNC_RM_FORMAT |
| HDMI_ASYNC_RM_INTEGRATOR | HDMI_ASYNC_RM_INTEGRATOR |
| HDMI_ASYNC_RM_OFFSET | HDMI_ASYNC_RM_OFFSET |
| HDMI_ASYNC_RM_PHASE_INC | HDMI_ASYNC_RM_PHASE_INC |
| HDMI_ASYNC_RM_RATE_RATIO | HDMI_ASYNC_RM_RATE_RATIO |
| HDMI_ASYNC_RM_SAMPLE_INC | HDMI_ASYNC_RM_SAMPLE_INC |
| HDMI_DMA | HDMI_DMA |
| HDMI_HDMI_13_AUDIO_CFG_1 | HDMI_HDMI_13_AUDIO_CFG_1 |
| HDMI_HDMI_13_AUDIO_STATUS_1 | HDMI_HDMI_13_AUDIO_STATUS_1 |
| HDMI_HDMI_HBR_AUDIO_PACKET_HEADER | HDMI_HDMI_HBR_AUDIO_PACKET_HEADER |
| HDMI_INTR2_BASE | HDMI_INTR2_BASE |
| HDMI_PCI_CLEAR | HDMI_PCI_CLEAR |
| HDMI_PCI_MASK_CLEAR | HDMI_PCI_MASK_CLEAR |
| HDMI_PCI_MASK_SET | HDMI_PCI_MASK_SET |
| HDMI_PCI_MASK_STATUS | HDMI_PCI_MASK_STATUS |
| HDMI_PCI_SET | HDMI_PCI_SET |
| HDMI_PCI_STATUS | HDMI_PCI_STATUS |
| HDMI_PERT_INSERT_ERR_SEPARATION | HDMI_PERT_INSERT_ERR_SEPARATION |
| HDMI_RAM_BASE | HDMI_RAM_BASE |
| HDMI_RAM_PACKET_RSVD_0 | HDMI_RAM_PACKET_RSVD_0 |
| HDMI_RAM_PACKET_RSVD_1 | HDMI_RAM_PACKET_RSVD_1 |
| HDMI_RBUS_REGS | HDMI_RBUS_REGS |
| HDMI_TX_PHY_BASE | HDMI_TX_PHY_BASE |
| HDMI_TX_PHY_HDMI65_TX_PHY_TMDS_CFG | HDMI_TX_PHY_HDMI65_TX_PHY_TMDS_CFG |
| HDMI_TX_PHY_HDMI_TX_PHY_CTL_0 | HDMI_TX_PHY_HDMI_TX_PHY_CTL_0 |
| HDMI_TX_PHY_HDMI_TX_PHY_CTL_1 | HDMI_TX_PHY_HDMI_TX_PHY_CTL_1 |
| HDMI_TX_PHY_HDMI_TX_PHY_CTL_2 | HDMI_TX_PHY_HDMI_TX_PHY_CTL_2 |
| HDMI_TX_PHY_HDMI_TX_PHY_PLL_CFG | HDMI_TX_PHY_HDMI_TX_PHY_PLL_CFG |
| HDMI_TX_PHY_HDMI_TX_PHY_RESET_CTL | HDMI_TX_PHY_HDMI_TX_PHY_RESET_CTL |
| HDMI_TX_PHY_HDMI_TX_PHY_SPARE | HDMI_TX_PHY_HDMI_TX_PHY_SPARE |
| HDMI_TX_PHY_HDMI_TX_PHY_STATUS | HDMI_TX_PHY_HDMI_TX_PHY_STATUS |
